...
<!--Start types metric & add-->
<div class="metric-add">
<div class="container">
<div class="row">

<div class="col-md-6">
<h5 class="float-left">You have {{$count_types}} types</h5>
</div>

<div class="col-md-6">
<button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#new-type">
  New type
</button>
</div>
  ...
  @foreach ($types as $type)
    <tr>
      <td>{{$type->type}}</td>
       ...
       <td><a class="btn btn-sm btn-danger" href="/delete-type/{{$type->id}}">Delete</a></td>
    </tr>
  @endforeach
  </tbody>
</table>
